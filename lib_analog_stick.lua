...
function NewStick( Props )
        ...
        Group.Border = display.newImage(Props.imageSheet, Props.imageMain)
        Group:insert(Group.Border)
		
        Group.Thumb = display.newImage(Props.imageSheet, Props.imageThumb)
        Group.Thumb.alpha = 0.5
        Group.Thumb.x0 = 0
        Group.Thumb.y0 = 0
        Group:insert(Group.Thumb)

        Group:scale(Props.scale, Props.scale)
        ...
        function Group:getMaxDistance () return self.maxDist end
